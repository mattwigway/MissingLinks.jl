...
write(joinpath(DATA_PATH, "linkmaps", "isochrone.tif"), sface, force=true)
```
...
Rasters.setcrs(access, GFT.EPSG(32119))
Rasters.setmappedcrs(access, GFT.EPSG(32119))
write(joinpath(DATA_PATH, "muskogee.tif"), access, force=true)
```
...
Rasters.setcrs(access, GFT.EPSG(32119))
Rasters.setmappedcrs(access, GFT.EPSG(32119))
write(joinpath(DATA_PATH, "linkmaps", "louise.tif"), access, force=true)
```
## Commonwealth
...
Rasters.setcrs(access, GFT.EPSG(32119))
Rasters.setmappedcrs(access, GFT.EPSG(32119))
write(joinpath(DATA_PATH, "linkmaps", "commonwealth.tif"), access, force=true)
```
