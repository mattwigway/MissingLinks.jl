@testsnippet InitializeScoring begin
    import MissingLinks: graph_from_gdal, score_links, CandidateLink, calculate_distances, VertexID
    import DataFrames: DataFrame
    import ArchGDAL as AG
    import Graphs: nv
end
    
@testitem "Missing link across disconnected components" setup=[InitializeScoring] begin
...
@testitem "Missing links across connected component" setup=[InitializeScoring] begin
    ...
    links = [
        CandidateLink(
            ...
            to_dist_from_start=0,
            to_dist_to_end=500,
            geographic_length_m=500,
            network_length_m=500
        )
    ]
...
@testitem "Middles" setup=[InitializeScoring] begin
    ...
    links = [
        CandidateLink(
            ...
            fr_dist_from_start=72,
            fr_dist_to_end=45,
            to_edge_src=VertexID(5),
            to_edge_tgt=VertexID(7),
            to_dist_from_start=72,
            to_dist_to_end=45,
            geographic_length_m=100,
            network_length_m=missing
        )
    ]
